...
const familyResidents: Record<string, FamilyResidentData> = {
  ...
  'resident-dorothy-webb': {
    ...
    wellnessScore: 88,
    wellnessLabel: 'Excellent',
    activityStatus: 'Active today — morning walk and coffee group',
    activityLevel: 'up',
    eventsThisWeek: 3,
    eventsList: ['Morning Walk Group (Mon)', 'Knitting Circle (Wed)', 'Movie Night (Fri)'],
    airQuality: 'Air quality is excellent',
    airQualityStatus: 'excellent',
    temperature: '72°F',
    tempComfort: 'Comfortable range',
    ...
    lastIncident: null,
    fallDetection: 'Fall detection active in all rooms',
    weeklyDigest: 'Dorothy had a wonderful week. She\'s been keeping up with her morning walks and joined the knitting circle for the first time on Wednesday. Her living environment has been consistently healthy, and she seems to be enjoying the social activities.',
    communityComparison: 'Dorothy\'s wellness score is above the community average',
  ...
  'resident-robert-chen': {
    ...
    wellnessScore: 67,
    wellnessLabel: 'Needs Attention',
    activityStatus: 'Low activity today — has stayed in his unit',
    activityLevel: 'down',
    eventsThisWeek: 1,
    eventsList: ['Coffee Social (Tue)'],
    airQuality: 'Air quality is fair',
    airQualityStatus: 'fair',
    temperature: '74°F',
    tempComfort: 'Slightly warm',
    incidentsThisMonth: 0,
    lastIncident: null,
    fallDetection: 'Fall detection active in all rooms — 2 missed medication reminders this week',
    weeklyDigest: 'Robert has been less active than usual this week. He attended the Tuesday coffee social but has otherwise stayed in his unit. Our wellness team has noted a gradual decline in activity and is coordinating with his care provider to ensure he\'s feeling well.',
    communityComparison: 'Our team is monitoring Robert\'s wellness trend closely',
