...
interface WellnessState {
  ...
  circadianData: Record<string, CircadianStatus>;
  behavioralData: Record<string, BehavioralPatterns>;
  ...
  getCircadianData: (unitId: string) => CircadianStatus | undefined;
  getBehavioralData: (unitId: string) => BehavioralPatterns | undefined;
