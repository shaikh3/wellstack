import { IEQDetailView } from "@/components/wellness/IEQDetailView";
...
export default async function IEQDetailPage({ params }: Props) {
  ...
  return <IEQDetailView propertyId={propertyId} unitId={unitId} />;
}
